            ...
            <div class="w-full flex-grow lg:flex lg:items-center lg:w-auto hidden mt-2 lg:mt-0 bg-white lg:bg-transparent text-black p-4 lg:p-0 z-20" id="nav-content">
                <ul class="list-reset lg:flex justify-end flex-1 items-center">
                    @if(Route::has('login'))
                            @auth
                                <li class="mr-3">
                                    <a href="{{ url('/home') }}" class="inline-block py-2 px-4 text-black font-bold no-underline">{{ __('Home') }}</a>
                                </li>
                            @else
                                <li class="mr-3">
                                    <a href="{{ route('login') }}" class="no-underline hover:no-underline text-sm font-normal text-teal-800 uppercase" href="#">{{ __('Login') }}</a>
                                </li>
                                @if (Route::has('register'))
                                <li class="mr-3">
                                    <a href="{{ route('register') }}" class="no-underline hover:no-underline text-sm font-normal text-teal-800 uppercase" href="#">{{ __('Register') }}</a>
                                </li>
                                @endif
                            @endauth
                    @endif
