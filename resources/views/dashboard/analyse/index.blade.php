                ...
                <div class="container px-6 mx-auto grid">
                  <h2 class="my-6 text-1xl font-semibold text-gray-500 dark:text-gray-200"> Api </h2>
                    <div class="flex items-center p-4 bg-white rounded-lg shadow-sdw dark:bg-gray-800">
                        <form class="w-full flex flex-wrap" action="{{route('analyse.dashboard-analyse-create')}}" method="post">
                            @csrf
                  ...
                  <div class="w-full overflow-hidden rounded-lg shadow-xs">
                    <div class="w-full overflow-x-auto">
                      ...
                      <!-- liste user --> 
                      <!-- card -->
                      @foreach ($liste_analyse as $liste_analyses)    
                        <div class="flex flex-wrap rounded-lg shadow-sdw py-3 mb-6 placeholder-blueGray-300 text-blueGray-600 bg-white text-sm focus:outline-none w-full ease-linear transition-all duration-150">
                            <div class="w-full lg:w-5/12 px-4 flex items-center">
                                <div class="relative w-full flex items-center">
                                    {{$liste_analyses->name}}
                                </div>
                            </div>
                            <div class="w-full lg:w-5/12 px-4 flex items-center">
                                <div class="relative w-full flex items-center text-violet">
                                    {{$liste_analyses->api_name}}
                                </div>
                            </div>
                            <div class="w-full lg:w-2/12 px-4 ">
                                <div class="relative w-full h-full flex justify-center items-center ">
                                      <a href="{{ route('analyse.dashboard-analyse-show', ['id' => $liste_analyses->id ])}}">
