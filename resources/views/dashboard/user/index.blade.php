                    ...
                    <div class="w-full overflow-x-auto">
                      ...
                      <div class="flex flex-wrap">
                        ...
                        <div class="w-full lg:w-1/12 px-4">
                            <div class="relative w-full mb-3  flex justify-center items-center">
                              <label
                                class="block uppercase text-blueGray-600 text-xs font-bold mb-2 text-center"
                              >
                                Contact
                              </label>
                            </div>
                      ...
                      @foreach ($liste_user as $liste_users)
                        <div class="flex flex-wrap rounded-lg shadow-sdw py-3 mb-6 placeholder-blueGray-300 text-blueGray-600 bg-white text-sm focus:outline-none w-full ease-linear transition-all duration-150">
                            <div class="w-full lg:w-3/12 px-4 flex items-center">
                                <div class="relative w-full flex items-center">
                                    {{$liste_users->name}} {{$liste_users->prenom}}
                                </div>
                            </div>
                            ...
                            <div class="w-full lg:w-3/12 px-4 flex items-center">
                                <div class="relative w-full flex items-center">
                                  {{$liste_users->poste_name}}
                                </div>
                            </div>
                            <div class="w-full lg:w-1/12 px-4">
                                <div class="relative w-full h-full flex justify-center items-center">
                                    <a href="#">
                                        <button class="px-1 py-1 rounded-lg bg-white fill-extra hover:fill-main">
                                            <svg
                            ...
                            <div class="w-full lg:w-1/12 px-4 ">
                                <div class="relative w-full h-full flex justify-center items-center ">
                                      <a href="{{ route('user.dashboard-user-edit', ['id' => $liste_users->id ])}}">
                                    ...
                                    <a onclick="return confirmdelete();" href="{{ route('user.dashboard-user-delete', ['id' => $liste_users->id ])}}">
